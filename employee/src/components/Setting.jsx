...
export default function Setting() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const { data } = await axios.get("https://backend-io23.onrender.com/employee/profile", {
  ...
  const handleSave = async () => {
    ...
    try {
      const token = sessionStorage.getItem('employeeToken');
      await axios.put("https://backend-io23.onrender.com/employee/profile", formData, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      const token = sessionStorage.getItem('employeeToken');
      await axios.put("https://backend-io23.onrender.com/employee/change-password", {
